...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const emFilters = {
            ...
            bot: botUuid,
            currency: 'emerald',
            startTime: parseDate(interaction.options.getString('later_than')) || parseDate(interaction.options.getString('date_range')?.split('~')[0]),
            endTime: parseDate(interaction.options.getString('earlier_than')) || parseDate(interaction.options.getString('date_range')?.split('~')[1]),
            minAmount: interaction.options.getInteger('greater_than') || emRange.min,
            maxAmount: interaction.options.getInteger('less_than') || emRange.max
        };
        ...
        const coinFilters = {
            ...
            bot: botUuid,
            currency: 'coin',
            startTime: parseDate(interaction.options.getString('coin_later_than')) || parseDate(interaction.options.getString('coin_date_range')?.split('~')[0]),
            endTime: parseDate(interaction.options.getString('coin_earlier_than')) || parseDate(interaction.options.getString('coin_date_range')?.split('~')[1]),
            minAmount: interaction.options.getInteger('coin_greater_than') || coinRange.min,
            maxAmount: interaction.options.getInteger('coin_less_than') || coinRange.max
        };
